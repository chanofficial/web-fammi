...
<head>
  ...
  <title>FAMMI | Data Pengurus</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url().'admin/guru'?>">
            <i class="fa fa-user"></i> <span>Data Pengurus</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>FAMMI &copy; 2020 <a href="http://chanofficial.rf.gd">chanofficial</a> X <a href="http://mfikri.com">M Fikri Setiadi</a>.</strong>
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmp_lahir" class="form-control" id="inputUserName" placeholder="Pesan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" class="form-control" id="inputUserName" placeholder="Contoh: ketua, sekretaris" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">pesan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmp_lahir" value="<?php echo $tmp_lahir;?>" class="form-control" id="inputUserName" placeholder="pesan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jabatan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" value="<?php echo $mapel;?>" class="form-control" id="inputUserName" placeholder="Contoh: ketua, sekretaris" required>
                                        </div>
                                    </div>
