...
<head>
    ...
    <title>FAMMI | <?php echo $title;?></title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                    ...
                    <h2 style="text-align: center;"><b><a href="<?php echo site_url('artikel/'.$slug);?>"><?php echo $title;?></a></b></h2>
                    
                   
                <div class="blog-img_block" style="padding-top: 20px;">
                    <img src="<?php echo base_url().'assets/images/'.$image?>" class="img-fluid" alt="blog-img">
                    
                </div>
                <div class="blog-tiltle_block">
                    <h6> <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo $author;?></span> </a>  |  <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span><?php echo $tanggal;?></span></a> | <a href="#"><i class="fa fa-tags" aria-hidden="true"></i><span><?php echo $kategori;?></span></a></h6>
                    <?php echo $blog;?>
                </div>
              ...
              <form action="<?php echo site_url('blog/search');?>" method="get">
                ...
                <div class="blog-featured_post">  
                 <h3> <a href="<?php echo site_url('jadwal-sholat');?>">Jadwal Sholat</a></h3>     
                    <p style="text-align: center;"><iframe src="https://jam.jadwalsholat.org/digitalclock/" frameborder="0" width="175" height="62"></iframe><br><iframe src="https://www.jadwalsholat.org/adzan/ajax.row.php?id=151" frameborder="0" width="220" height="220"></iframe></p>
                </div>
