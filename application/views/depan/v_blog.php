...
<section class="blog-wrap">
    <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 style="text-align: center;">PORTAL BERITA <br>FORUM ANAK MUDA MASJID INDONESIA</h1>
              ...
              <?php foreach ($data->result() as $row) : ?>
                <div class="blog-single-item">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span><?php echo $row->tanggal;?></span></a> | 
                         <a href="#"><i class="fa fa-tags" aria-hidden="true"></i><span><?php echo $row->tulisan_kategori_nama;?></span></a></h6>
                        <?php echo limit_words($row->tulisan_isi,40).'...';?>
                        <div class="blog-icons">
                            <div class="">
                                <div class="w3-container">
                                <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>" class="w3-button w3-khaki w3-round-xlarge">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="blog-category_block">
                 ...
                 <div class="blog-featured_post">  
                  <h3> <a href="<?php echo site_url('jadwal-sholat');?>">Jadwal Sholat</a></h3>    
                    <p style="text-align: center;"><iframe src="https://jam.jadwalsholat.org/digitalclock/" frameborder="0" width="175" height="70"></iframe><br><iframe src="https://www.jadwalsholat.org/adzan/ajax.row.php?id=151" frameborder="0" width="220" height="220"></iframe></p>
                </div>
